...
### 2. [GitHub](https://github.com/NIFCloud-mbaas/ObjcPayloadApp_iOS10)からサンプルプロジェクトのダウンロード

* 下記リンクをクリックしてプロジェクトをダウンロードをMacにダウンロードします

 * __[ObjcPayloadApp](https://github.com/NIFCloud-mbaas/ObjcPayloadApp_iOS10/archive/master.zip)__
...
### サンプルプロジェクトに実装済みの内容
#### SDKのインポートと初期設定
* ニフクラ mobile backend の[ドキュメント（クイックスタート）](https://mbaas.nifcloud.com/doc/current/introduction/quickstart_ios.html)を、ご活用ください
...
## 参考
* ニフクラ mobile backend の[ドキュメント（プッシュ通知）](https://mbaas.nifcloud.com/doc/current/push/basic_usage_ios.html)を、ご活用ください
* 同じ内容の【Swift】版もご用意しています
 * [SwiftPayloadApp_iOS10](https://github.com/NIFCloud-mbaas/SwiftPayloadApp_iOS10)
